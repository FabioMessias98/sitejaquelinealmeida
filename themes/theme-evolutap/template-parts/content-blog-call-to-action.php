		...
		<div class="row flex-wrap justify-content-center">
			<div class="col-xl-5 col-lg-8 col-md-10 d-flex flex-column flex-xl-wrap justify-content-xl-between justify-content-md-center">
				...
				<div class="bg-folk--pink py-5 rounded-lg mt-3">
					...
					<img class="mx-2 d-none d-md-flex" src="<?= get_template_directory_uri() ?>/assets/public/images/group-jaque.png" alt="equipe jaque" loading="lazy" decoding="async">

					<div class="col-md-6 col-8 mx-3">
						<a href="" class="button-cta py-3 px-5 mt-md-n3 mt-0 d-block font-size-22">Join Now</a>
					</div>
				</div>
			...
			<div class="col-xl-5 col-lg-8 col-md-10 flex-lg-column justify-content-md-center">
				...
				<div class="bg-folk--purple-clear py-4 rounded-lg mt-3 banner-with-me">
					...
					<ul class="u-list-style-none pl-md-10 pl-3 py-3">
						<li class="u-icon__phone u-icon__free before::u-font-weight-black before:font-size-45 before::color-folk--purple">
							<a class="text-white u-font-size-22 md:u-font-size-17 ml-2" href="tel:3530899434826">+ 353 089 943 4826</a> 
						</li>
						<li class="u-icon__message u-icon__free before::u-font-weight-black before:font-size-45 before::color-folk--purple">
							<a class="text-white u-font-size-22 md:u-font-size-17 ml-2" href="mailto:ja@jaquelinealmeida.com">ja@jaquelinealmeida.com</a> 
						</li>
					</ul>

					<div class="col-11 pl-md-10 pl-3">
